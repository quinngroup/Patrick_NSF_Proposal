...
% use proposed work subsection as above (maybe even some previous work, ie mention your skills in phylogenetics)
...
% move this to section 2 and expand with background and more proposal details
...
% add the aspects of personality that were found to be associated

Other work has attempted to use the big five personality to determine sentiments towards prescription drug abuse\cite{}. % more on this
...
% in background (unlabeled section, clearly state goals, and background)

% previous work, show the work you've been working on comparing pharmaceuticals and personality keywords

% follow the outline you've made in your jupyter notebook

% Truvada is the case study

% there may be some good content here that you can salvage
